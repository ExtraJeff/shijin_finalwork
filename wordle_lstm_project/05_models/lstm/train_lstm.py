# -*- coding: utf-8 -*-
"""
Train LSTM model with visualization
"""
...
wandb.init(
        ...
        name="lstm-train-" + os.path.basename(MODEL_DIR)
    )
...
plot_training_history(history, "lstm", OUTPUT_DIR)

# Plot prediction distribution and errors
plot_prediction_distribution(y_test, y_pred_reg, "lstm", OUTPUT_DIR)

# Plot metrics summary
plot_metrics_summary(metrics, "lstm", OUTPUT_DIR)

# Plot error by player activity
plot_error_by_player_activity(y_test, y_pred_reg, X_feat_test, "lstm", OUTPUT_DIR)

# Plot confusion matrix and ROC curve
plot_confusion_matrix(y_true_class, y_pred_class, y_pred_class_prob.flatten(), "lstm", OUTPUT_DIR)
