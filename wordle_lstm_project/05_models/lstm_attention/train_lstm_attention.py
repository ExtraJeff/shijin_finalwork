# -*- coding: utf-8 -*-
"""
Train LSTM + Attention model with visualization
"""
...
wandb.init(
    ...
    name="lstm-attention-train-" + os.path.basename(MODEL_DIR)
)
...
plot_training_history(history, "lstm_attention", OUTPUT_DIR)

# Plot prediction distribution and errors
plot_prediction_distribution(y_test, y_pred_reg, "lstm_attention", OUTPUT_DIR)

# Plot metrics summary
plot_metrics_summary(metrics, "lstm_attention", OUTPUT_DIR)

# Plot error by player activity
plot_error_by_player_activity(y_test, y_pred_reg, X_feat_test, "lstm_attention", OUTPUT_DIR)

# Finish WandB run
print("Finishing WandB run...")
wandb.finish()

print("LSTM + Attention model training and evaluation completed!")
