# -*- coding: utf-8 -*-
"""
Train Transformer model with visualization
"""
...
wandb.init(
    ...
    name="transformer-train-" + os.path.basename(MODEL_DIR)
)
...
plot_training_history(history, "transformer", OUTPUT_DIR)

# Plot prediction distribution and errors
plot_prediction_distribution(y_test, y_pred_reg, "transformer", OUTPUT_DIR)

# Plot metrics summary
plot_metrics_summary(metrics, "transformer", OUTPUT_DIR)

# Plot error by player activity
plot_error_by_player_activity(y_test, y_pred_reg, X_feat_test, "transformer", OUTPUT_DIR)
